...
subtitle: "`r emo::ji('cake')` start with cake! <br> `r emo::ji('link')` [bit.ly/teach-ds-wsc](https://bit.ly/teach-ds-wsc)"
...
.pull-left[
```{r kitchen-inrepair, echo=FALSE, fig.alt = "A kitchen in shambles that needs repair."}
knitr::include_graphics("img/kitchen-inrepair.png")
```
]
.pull-right[
```{r kitchen-built, echo=FALSE, fig.alt = "A neat and tidy kitchen that needs no repair."}
...
.pull-left[
```{r kitchen-inrepair-small, echo=FALSE, out.height=250, fig.alt = "A kitchen in shambles that needs repair."}
knitr::include_graphics("img/kitchen-inrepair.png")
```
- Install R
- Install RStudio
...
.pull-right[
```{r kitchen-built-small, echo=FALSE, out.height=250, fig.alt = "A neat and tidy kitchen that needs no repair."}
knitr::include_graphics("img/kitchen-built.png")
```
...
.your-turn[
- Go to [bit.ly/teach-ds-wsc-cloud](https://bit.ly/teach-ds-wsc-cloud) to join the RStudio Cloud workspace for this workshop
- Start the assignment called **UN Votes**
- Open the R Markdown document called `un-votes.Rmd`and click on **Knit**
...
.pull-left[
```{r recipe-picture, echo=FALSE, fig.alt = "A recipe with words and pictures."}
knitr::include_graphics("img/recipe-picture.png")
```
]
.pull-right[
```{r recipe-words, echo=FALSE, fig.alt = "A recipe with words only."}
...
.pull-left[
```{r recipe-picture-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "A recipe with words and pictures."}
knitr::include_graphics("img/recipe-picture.png")
```
...
.pull-right[
```{r recipe-words-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "A recipe with words only."}
knitr::include_graphics("img/recipe-words.png")
```
.small[
```{r recipe-words-code}
...
.pull-left[
```{r chop-onions, echo=FALSE, fig.alt = "Knife and chopped onions."}
knitr::include_graphics("img/chop-onions.png")
```
]
.pull-right[
```{r make-ratatouille, echo=FALSE, fig.alt = "A plate of ratatouille."}
...
.pull-left[
```{r chop-onions-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "Knife and chopped onions."}
knitr::include_graphics("img/chop-onions.png")
```
...
.pull-right[
```{r make-ratatouille-small, echo=FALSE, out.height=120, out.width=250, fig.align="center", fig.alt = "A plate of ratatouille."}
knitr::include_graphics("img/make-ratatouille.png")
```
.small[
...
.pull-left[
```{r owl-1, echo=FALSE, fig.align="right", out.height=390, out.width=250, fig.alt = "Step 1 of drawing an owl is two circles, one for head and one for body."}
knitr::include_graphics("img/owl-step1.png")
```
]
.pull-right[
```{r owl-2, echo=FALSE, fig.align="left", out.height=390, out.width=250, fig.alt = "Step 2 of drawing an owl is drawing the entire owl, with all details."}
...
.pull-right[
```{r ref.label="scaffold-layer-1", echo=FALSE, out.width = "100%", fig.alt = "A plot with an empty background, no data shown."}
```
]
...
.pull-right[
```{r ref.label="scaffold-layer-2", echo=FALSE, out.width = "100%", fig.alt = "A frequency bar plot with whether the vote was considered important or not on the x-axis and bars filled with the vote (yes, no, or abstain)."}
```
]
...
.pull-right[
```{r ref.label="scaffold-layer-3", echo=FALSE, out.width = "100%", fig.alt = "A relative frequency bar plot with whether the vote was considered important or not on the x-axis and bars filled with the vote (yes, no, or abstain)."}
```
]
...
.pull-right[
```{r ref.label="scaffold-layer-5", echo=FALSE, out.width = "100%", fig.asp = 1.3, fig.alt = "A relative frequency bar plot with whether the vote was considered important or not on the x-axis and bars filled with the vote (yes, no, or abstain), faceted by issue (colonialism, arms control and disarmament, economic development, human rights, Palestinian conflict, and nuclear weapons and nuclear material). Plot also has a title and subtitle."}
```
]
...
.pull-right[
```{r ref.label="scaffold-layer-6", echo=FALSE, out.width = "100%", fig.asp = 1.3, fig.alt = "A relative frequency bar plot with whether the vote was considered important or not on the x-axis and bars filled with the vote (yes, no, or abstain), faceted by issue (colonialism, arms control and disarmament, economic development, human rights, Palestinian conflict, and nuclear weapons and nuclear material). Plot also has a title and subtitle and the legend label is customized."}
```
]
...
```{r echo=FALSE, fig.alt = "Screenshot of a learnr tutorial."}
...
.pull-left[
```{r broccoli-raw, echo=FALSE, fig.alt = "Raw broccoli."}
knitr::include_graphics("img/broccoli-raw.png")
```
]
.pull-right[
```{r broccoli-cooked, echo=FALSE, fig.alt = "Cooked broccoli in a noodle dish."}
...
.pull-left-narrow[
```{r broccoli-raw-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "Raw broccoli."}
knitr::include_graphics("img/broccoli-raw.png")
```
...
.pull-right-wide[
```{r broccoli-cooked-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "Cooked broccoli in a noodle dish."}
knitr::include_graphics("img/broccoli-cooked.png")
```

- Today we go from this to that
```{r echo=FALSE, fig.alt = "Screenshot of a page from OpenSecrets.org on contributions to North Carolina congressional races."}
...
```{r open-secrets-nc-ex1, echo=FALSE, out.width="70%", fig.align="center", fig.alt = "Screenshot of an HTML table on OpenSecrets.org and the version of the same table loaded into R."}
...
```{r open-secrets-nc-ex2, echo=FALSE, out.width="50%", fig.align="center", fig.alt = "Maps of North Carolina with colors indicating the amount of money raised of political races with Challenger and Incumbent on the x-axis and Democrat, Republican, and Third Party on the y-axis."}
...
```{r open-secrets-nc-ex3, echo=FALSE, out.width="100%", fig.alt = "On the left, a data frame with a single column titled candidate_info that has information on the name of the candidate, the party affiliation, and whether they're a challenger or an incumbent. On the right, a data frame where the same pieces of information spread across three separate columns."}
...
.pull-left[
```{r make-pastries, echo=FALSE, fig.alt = "Plate of pastries."}
knitr::include_graphics("img/make-pastries.png")
```
]
.pull-right[
```{r make-tacos, echo=FALSE, fig.alt = "Plate of tacos."}
...
.pull-left[
```{r make-pastries-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "Plate of pastries."}
knitr::include_graphics("img/make-pastries.png")
```
.small[
```{r cache=TRUE}
...
.pull-right[
```{r make-tacos-small, echo=FALSE, out.height=150, out.width=250, fig.align="center", fig.alt = "Plate of tacos."}
knitr::include_graphics("img/make-tacos.png")
```
.small[
```{r}
