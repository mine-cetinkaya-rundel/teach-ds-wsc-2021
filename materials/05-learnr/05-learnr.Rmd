---
title: "05 <br> interactivity and immediate feedback"
subtitle: "`r emo::ji('dizzy')` with learnr <br> `r emo::ji('link')` [bit.ly/teach-ds-wsc](https://bit.ly/teach-ds-wsc)"
...
--
.pull-right-narrow[
```{r echo=FALSE, fig.align="right", fig.alt = "Illustration of student with a speech bubble saying 'Object of type what now?'"}
...
```{r message=FALSE, fig.height=2.5, fig.width=9, dpi=300, out.width="70%", fig.alt = "Scatterplot of highway mielage and city mileage where points are colored by year and a linear model is represented with a line with a positive slope on the plot."}
...
.pull-right-narrow[
```{r echo=FALSE, fig.align="center", fig.alt = "Illustration of a teacher with a speech bubble that says 'So much to say, so little time...'"}
...
```{r echo=FALSE, out.width="70%", fig.align="center", fig.alt = "Two puzzle pieces that fit together, one says learnr and the other gradethis."}
...
- Go to [bit.ly/teach-ds-wsc-cloud](https://bit.ly/teach-ds-wsc-cloud), the RStudio Cloud workspace for this workshop
- Start the assignment titled **Penguins**
...
```{r echo=FALSE, out.width="85%", fig.align="center", fig.alt = "Screenshot of a sample learnr tutorial."}
...
```{r echo=FALSE, out.width="75%", fig.align="center", fig.align="center", fig.alt = "Screenshots of resources listed in bullet points in slide."}
